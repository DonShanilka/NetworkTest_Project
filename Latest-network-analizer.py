...
class NetworkMonitor(QtWidgets.QWidget):  
    ...
    def initUI(self):
        ...
        self.welcome_label.setStyleSheet("font-size: 30px; color: #660066; padding: 3px;")
        ...
        self.total_usage_label.setStyleSheet("font-size: 16px; padding: 3px; color: #ff7733;")
        ...
        self.getIPButton.setStyleSheet("width: 400px;  font-size: 14px; padding: 5px; background-color: #4da6ff; color: #001a33; border-radius: 4px;")
...
class LoginWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.setFixedSize(self.sizeHint().width(), int(self.sizeHint().height() * 0.6))  # Set height to 60% of the screen height
