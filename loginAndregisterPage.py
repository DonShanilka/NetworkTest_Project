...
class LoginRegisterApp(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        # Home Page
        self.home_widget = NetworkMonitor()
        ...
        # Add home widget to the layout
        self.layout.addWidget(self.home_widget)
        self.layout.setCurrentWidget(self.tab_widget)
    ...
    def login(self):
        ...
        for user in user_data:
            if user['username'] == username and user['password'] == encrypted_password:
                self.show_home_page(username, encrypted_password)
                return
        
        QMessageBox.warning(self, "Login Failed", "Invalid username or password.")

    def show_home_page(self, username, encrypted_password):
        self.home_widget.setWindowTitle(f"Welcome, {username}!")
